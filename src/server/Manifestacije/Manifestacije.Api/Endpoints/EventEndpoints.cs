...
//         IEventService eventService)
//     {
//         var events = await eventService.GetAllEventsAsync(queryFilter);
...
//             : Results.Ok(EventMapper.EventListToEventViewResponseList(eventModel));
//     }
//     
...
//         }
//
//         var updatedEvent = await eventService.UpdateEventAsync(updateEventRequest);
